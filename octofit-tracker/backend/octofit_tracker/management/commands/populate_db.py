...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users = [
            ...
            {"_id": ObjectId(), "email": "metalgeek@mhigh.edu", "name": "Tony Stark", "age": 35},
            {"_id": ObjectId(), "email": "zerocool@mhigh.edu", "name": "Steve Rogers", "age": 32},
            {"_id": ObjectId(), "email": "crashoverride@mhigh.edu", "name": "Natasha Romanoff", "age": 28},
            {"_id": ObjectId(), "email": "sleeptoken@mhigh.edu", "name": "Bruce Banner", "age": 40},
        ]
        ...
        # Create activities
        activities = [
            {"_id": ObjectId(), "user": users[0]["_id"], "type": "Cycling", "duration": 60},
            {"_id": ObjectId(), "user": users[1]["_id"], "type": "Crossfit", "duration": 120},
            {"_id": ObjectId(), "user": users[2]["_id"], "type": "Running", "duration": 90},
            {"_id": ObjectId(), "user": users[3]["_id"], "type": "Strength", "duration": 30},
            {"_id": ObjectId(), "user": users[4]["_id"], "type": "Swimming", "duration": 75},
        ]
